---
title: "Is there a better way to measure Olympic medals?"
...
# Problem Description
It is recommended to introduce a new way of measuring countries' Olympic performance called Weighted Total Score, which gives countries 3 points for a winning a gold medal, 2 points for a silver, and 1 point for a bronze. The benefit of this measure is that it is inclusive of all medals won while placing greater importance of gold medals over silver medals over bronze medals. A limitation of this measure is that the public may find it challenging to adopt a new way of evaluating Olympic performance. 


# INTRODUCTION TO THE PROBLEM 
The International Olympic Committee's (IOC) current approach to measuring a country's Olympic performance is tallying gold medals. Simply put, the country that wins the most gold medals is considered the winner of the Olympic Games. While silver and bronze medals are recorded, they do not affect the final tally unless two countries are tied with gold medals.
...
* **Total Medals** - the total number of gold, silver, and bronze medals that a country won at the 2024 Olympic games. Data type is numeric. 
